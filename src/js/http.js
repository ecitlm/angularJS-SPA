define(['app', 'axios'], function (app, axios) {
  app.service('$api', function () {
    ...
    return {
      add: function add(mun1, mun2) {
        console.log(axios)
        return mun1 + mun2
      },
      getNews: function () {
        var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
        return httpRequest.apply(undefined, ['http://www.runoob.com/try/angularjs/data/sites.php'].concat(Array.prototype.slice.call(arguments)))
      }
    }
  })
})
