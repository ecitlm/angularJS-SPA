...
(function (global, factory) {
  ...
  function copy (src, dest) {
    if (dest) { Object.keys(dest).forEach(function (key) { return delete dest[key] }) }
    if (!dest) { dest = {} }
  ...
  function _equals (o1, o2) {
    ...
    if (predicates.map(any).reduce(function (b, fn) { return b || !!fn(tup) }, false)) { return false }
    var keys = {}
    // tslint:disable-next-line:forin
    for (var key in o1) {
  ...
  var StateRegistry = /** @class */ (function () {
    ...
    StateRegistry.prototype.get = function (stateOrName, base) {
      var _this = this
      if (arguments.length === 0) { return Object.keys(this.states).map(function (name) { return _this.states[name].self }) }
  ...
  var Transition = /** @class */ (function () {
    ...
    Transition.prototype.injector = function (state, pathName) {
      ...
      if (state) { path = PathUtils.subPath(path, function (node) { return node.state === state || node.state.name === state }) }
  ...
  var UrlMatcherFactory = /** @class */ (function () {
    ...
    UrlMatcherFactory.prototype.isMatcher = function (object) {
      ...
      forEach(UrlMatcher.prototype, function (val$$1, name) {
        if (isFunction(val$$1)) { result = result && (isDefined(object[name]) && isFunction(object[name])) }
      })
      return result
    }
    /** @hidden */
